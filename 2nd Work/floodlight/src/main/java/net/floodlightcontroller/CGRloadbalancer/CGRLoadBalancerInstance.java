...
public class CGRLoadBalancerInstance 
{
	 ...
	 */
	public CGRLoadBalancerInstance(int virtualIP, byte[] virtualMAC, 
	 ...
	 * @param hostIPs IPs for hosts to which requests should be balanced 
	 */
	public CGRLoadBalancerInstance(String virtualIP, String virtualMAC,
			String[] hostIPs)
	{
		this.virtualIP = IPv4.toIPv4Address(virtualIP);
		this.virtualMAC = MacAddress.of(virtualMAC).getBytes();
	...
	public String toString()
	{
		...
		result += " " + MacAddress.of(this.virtualMAC).toString() + " ";
