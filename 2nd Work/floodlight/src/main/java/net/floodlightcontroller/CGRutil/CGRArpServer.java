...
public class CGRArpServer implements IFloodlightModule, IOFMessageListener
{
	public static final String MODULE_NAME = CGRArpServer.class.getSimpleName();
			...
			IOFSwitch sw, OFMessage msg, FloodlightContext cntx) 
	{
		...
		OFPacketIn Packet_in = (OFPacketIn) msg;
		...
		int targetIP = IPv4.toIPv4Address(arp.getTargetProtocolAddress().getBytes());
		...
		Iterator<? extends IDevice> deviceIterator = 
				this.deviceProv.queryDevices(MacAddress.NONE, null, arp.getTargetProtocolAddress(),IPv6Address.NONE, DatapathId.NONE, OFPort.ZERO);
